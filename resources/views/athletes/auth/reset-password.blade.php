    ...
    <div uk-grid>
        <div class="uk-width-1-2@s uk-width-1-3@m">
            <div class="uk-card uk-card-small uk-card-default uk-card-body">
                ...
                <form class="uk-form-stacked" method="POST" action="{{route('athlete-password.update',$athlete->email)}}">
                    {!! csrf_field() !!}
                    @METHOD('PUT')
                    <div class="uk-margin-bottom">
                        <label class="uk-form-label" for="email">E-Mail-Adresse</label>
                        <div class="uk-form-controls">
                            <input class="uk-input" id="email" name="email" type="text"  value="{{$athlete->email }}" readonly>
                        </div>
                    </div>
                    ...
                    <div class="uk-margin-bottom">
                        <label class="uk-form-label" for="email">Password</label>
                        <div class="uk-form-controls">
                    ...
                    <div class="uk-margin-bottom">
                        <label class="uk-form-label" for="email">Confirm Password</label>
                        <div class="uk-form-controls">
                    ...
                    <button type="submit" class="uk-button uk-button-default">Reset</button>
